...
def scrape_data():
    links_file_path = "../data/alonhadat_links.txt"
    data_file_path = "../data/alonhadat_data.tsv"
    ...
    def process_link(link):
        ...
        scraped_data = scrapeAlonhadat.scrape_data(url)
        if scraped_data:
